...
<div class="content-wrapper">
  <h1 class="text-center" style="color:rgb(246, 120, 58);">Ajouter un nouveau demandeur</h1>
  <form class="col-md-12 col-lg-10 offset-1" action="{{route('store.addDemandeur')}}" method="POST" enctype="multipart/form-data">
    @csrf
